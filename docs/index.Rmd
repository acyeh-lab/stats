...
### Logistic Regression 
Unlike a linear regression where the outcome is continuous (e.g. blood pressure change), a logistic regression is used to predict a binary outcome (e.g. occurrence of a heart attack), based on prior observations of a data set.
