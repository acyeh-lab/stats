...
### Effect sizes
Power calculations to determine sample size requires an input for effect size. Different test outcomes calculate effect sizes differently - common situations are shown below, along with the generally accepted "small", "medium", and "large" effect sizes. Note that for more complex outcome measurements (such as for cox-proportional hazards model for survival analysis), there is not a simple variable that captures the effect size.
