...
---
For a great introductory R Workshop on working and visualizing data analyses, please visit Dr. Andrew Portuguese's site: https://aportugu.github.io/Rworkshop/.
...
### Considerations
To perform most basic power analyses, you need three of the four variables (you can determine the last variable if given the first 3):
